...
let rotationVal=0;
setInterval(() => {
    rotationVal += 120; // increases the rotation by 120 degrees every 3 seconds
    dishSlider.style.transform = `translateY(-50%) rotate(${rotationVal}deg)`; // applies rotation and vertical translation
}, 3000);
